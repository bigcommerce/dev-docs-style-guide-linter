module.exports = {
    ...
    permanentURL: {
        ...
        explanation: 'Use "permanent URL" instead in reference to permanent BigCommerce store URL.'
    },
    sku: {
        fn: function (text) {
            var positives = ["sku"];
    ...
    clickOn: {
        ...
        explanation: 'Use *click* instead. When the environment is a desktop with a mouse, use click for most targets, such as buttons, links, list items, and radio buttons.'
    },
    clickHere: {
        fn: function (text) {
    ...
    cpu: {
        ...
        explanation: 'Use *CPU* instead. All caps. No need to expand the abbreviation on first mention.'
    },
    currently: {
        fn: function (text) {
    ...
    deepLinking: {
        ...
        explanation: 'Use *deep linking* instead. However, if it would work to replace with *linking,* then do that.'
    },
    desire: {
        fn: function (text) {
    ...
    leverage: {
        ...
        explanation: 'Avoid using if you mean *use*. If possible, use a more precise term. For example, *use*, *build on*, or *take advantage of*.'
    },
    lifecycle: {
        fn: function (text) {
    ...
    login: {
        ...
        explanation: 'For the verb form, *sign in* is generally better, but if you\'re documenting a tool that uses the term *log in*, then use the term that the tool uses.'
    },
    login: {
        fn: function (text) {
            var positives = ["login", "log-in"];
    ...
    markdown: {
        ...
        explanation: 'Always capitalized, even when you\'re referring to a nonstandard version.'
    },
    markup: {
        fn: function (text) {
    ...
    may: {
        ...
        explanation: 'In general, reserve for official policy or legal considerations. To convey *possibility*, use *might* instead. To convey *permission*, use *can* instead.'
    },
    na: {
        fn: function (text) {
            var positives = ["\\bna\\b"];
        ...
        explanation: 'Use *N/A* instead. Spell out as *not available* or *not applicable* on first reference.'
    },
    nameserver: {
        fn: function (text) {
    ...
    path: {
        ...
        explanation: 'Use *path* instead. Avoid using *filepath*, *file path*, *pathname*, or *path name* if possible.'
    },
    please: {
        fn: function (text) {
    ...
    pros: {
        ...
        explanation: 'Don\'t use. Instead, use something else, such as *advantages*.'
    },
    quick: {
        fn: function (text) {
            var positives = ["quick"];
        ...
        explanation: 'What might be quick for you might not be quick for others. Try eliminating this word from the sentence because usually the same meaning can be conveyed without it.'
    },
    quota: {
        fn: function (text) {
            var positives = ["quota"];
        ...
        explanation: 'In API contexts, often refers to API usage limits. Where possible, best to use a more specific term than *quota*, such as *usage limit*; the word *quota* means many different things to many different people.'
    },
    regex: {
        fn: function (text) {
            var positives = ["regex"];
    ...
    representationalStateTransfer: {
        ...
        explanation: 'Don\'t use. To people unfamiliar with REST, this acronym expansion is meaningless; it\'s better to refer to it as REST and not bother trying to explain what it theoretically stands for.'
    },
    saas: {
        fn: function (text) {
    ...
    signout: {
        ...
        explanation: 'sign-out (noun or adjective), sign out (verb); not *log out* or *signout*'
    },
    since: {
        fn: function (text) {
        ...
        explanation: 'If you mean *because*, then use *because* instead of *since*. *Since* is ambiguous; it can refer to the passage of time. *Because* refers to causation or the reason for something.'
    },
    singlemost: {
        fn: function (text) {
    ...
    smartphone: {
        ...
        explanation: 'Don\'t use. Instead, use [*mobile phone*](https://developers.google.com/style/word-list#mobile) or *phone*.'
    },
    spinUp: {
        fn: function (text) {
        ...
        explanation: 'As in *spin up an instance*. Avoid using *spin up* unless you\'re referring to a hard disk; instead, use a less colloquial term like *create* or *start*.'
    },
    stylesheet: {
        fn: function (text) {
        ...
        explanation: 'Unless used in code, use *style sheet*; not *stylesheet*. This is the official spelling, per the World Wide Web Consortium (W3C).'
    },
    stylesheet: {
        fn: function (text) {
            var positives = ["stylesheet"];
    ...
    textbox: {
        ...
        explanation: 'Don\'t use. Instead, use *box*. For more information, see [Text box](https://developers.google.com/style/ui-elements#term-textbox).'
    },
    textbox: {
        fn: function (text) {
            var positives = ["textbox", "text box"];
    ...
    uncheck: {
        ...
        explanation: 'Don\'t use to refer to clearing a check mark from a checkbox. Instead, use *clear*.'
    },
    unselect: {
        fn: function (text) {
        ...
        explanation: 'Don\'t use. Instead, use *clear* for checkboxes, and *deselect* for other UI elements.'
    },
    unarchive: {
        fn: function (text) {
    ...
    utilize: {
        ...
        explanation: 'Use with caution. Don\'t use *utilize* when you mean *use*. It\'s OK to use *utilize* or *utilization* when referring to the quantity of a resource being used.'
    },
    via: {
        fn: function (text) {
    ...
    viceVersa: {
        ...
        explanation: 'Don\'t use. Instead, use a phrase like *the other way around*, *conversely*, or *otherwise*. In some contexts, vice versa is unclear or imprecise because in a complex sentence it\'s hard to know which two things are swapped with each other. In such cases, make it explicitly clear what two things are swapped.'
    },
    voila: {
        fn: function (text) {
            var positives = ["voila"];
    ...
    vs: {
        ...
        explanation: 'Don\'t use *vs.* as an abbreviation for *versus*; instead, use the unabbreviated *versus*.'
    },
    walkthrough: {
        fn: function (text) {
    ...
    webpage: {
        ...
        explanation: '*web page*; not *webpage*. But where possible, avoid both by using *page*.'
    },
    webpage: {
        fn: function (text) {
            var positives = ["webpage"];
    ...
    whitelist: {
        ...
        explanation: 'Don\'t use. See [blacklist](https://developers.google.com/style/word-list#blacklist).'
    },
    whitespace: {
        fn: function (text) {
    ...
    will: {
        ...
        explanation: 'Avoid. Applies equally to its past tense, *would*. See also [Present tense](https://developers.google.com/style/tense) and [Documenting future features](https://developers.google.com/style/future).'
    },
    wifi: {
        fn: function (text) {
        ...
        explanation: '*Wi-Fi*; not *wifi* or *WiFi*. When possible, instead use *wireless*.'
    },
    wildcard: {
        fn: function (text) {

...
- [Scripts API](#scripts-api)
  ...
  - [Script Manager API partner guidelines](#script-manager-api-partner-guidelines)
      - [Stencil vs Blueprint](#stencil-vs-blueprint)
  - [Prerequisites](#prerequisites)
  - [Upgrades and installation](#upgrades-and-installation)
    - [Installing an app on Stencil](#installing-an-app-on-stencil)
      - [Upgrading existing apps on Stencil](#upgrading-existing-apps-on-stencil)
    - [Installing apps on Blueprint stores](#installing-apps-on-blueprint-stores)
    - [Existing Blueprint installations](#existing-blueprint-installations)
